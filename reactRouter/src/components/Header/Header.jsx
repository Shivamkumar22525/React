    ...
    return(
       <header className='shadow sticky z-50 top-0'>
            <nav className='bg-white border-gray-200 px-4 lg:px-6 py-2.5'>
                <div className='flex flx-wrap justify-between item-center mx-auto max-w-screen-xl'>                    
                    ...
                    <Link to="#" className="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Log in
                        ...
                        <Link to='#' className='text-gray-800 hover:bg-orange-800 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus-outline-none'>Get Started</Link>
                    </div>
                    <div className='hidden justify-between item-center w-full lg:flex lg:w-auto lg-order-1' id='mobile-menu-2'>
